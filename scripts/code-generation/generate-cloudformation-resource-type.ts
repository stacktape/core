...
function typeNameToAwsType(typeName: string): string {
  ...
  const knownServices = [
    'S3', 'Lambda', 'Logs', 'Ec2', 'Iam', 'Rds', 'Dynamodb', 'Sqs', 'Sns',
    'Cloudfront', 'Route53', 'Apigateway', 'Apigatewayv2', 'Ecs', 'Ecr',
    'Elasticloadbalancingv2', 'Elasticache', 'Elasticsearch', 'Opensearchservice',
    'Secretsmanager', 'Ssm', 'Cloudwatch', 'Events', 'Scheduler', 'Stepfunctions',
    'Kinesis', 'Firehose', 'Cognito', 'Wafv2', 'Cloudformation', 'Codedeploy',
    'Codebuild', 'Codepipeline', 'Batch', 'Efs', 'Kms', 'Acm', 'Ses', 'Pipes',
    'Applicationautoscaling', 'Autoscaling', 'Apprunner', 'Appsync', 'Athena',
    'Backup', 'Cloudtrail', 'Config', 'Dax', 'Docdb', 'Glue', 'Iot', 'Msk',
    'Neptune', 'Redshift', 'Sagemaker', 'Transfer', 'Vpc', 'Vpclattice', 'Waf',
    'Wafregional', 'Workspaces', 'Workspacesweb', 'Workspacesthinclient',
    'Xray', 'Wisdom', 'Voiceid', 'Verifiedpermissions', 'Timestream', 'Synthetics',
    'Supportapp', 'Systemsmanagersap', 'Ssmcontacts', 'Ssmincidents', 'Sso',
    'Amplify', 'Amplifyuibuilder', 'Amazonmq', 'Appconfig', 'Appflow',
    'Appintegrations', 'Applicationinsights', 'Applicationsignals', 'Appmesh',
    'Appstream', 'Apptest', 'Aps', 'Arczonalshift', 'Auditmanager', 'Autoscalingplans',
    'B2bi', 'Bcmdataexports', 'Bedrock', 'Billingconductor', 'Budgets', 'Cassandra',
    'Ce', 'Certificatemanager', 'Chatbot', 'Cleanrooms', 'Cleanroomsml', 'Cloud9',
    'Codeartifact', 'Codecommit', 'Codeconnections', 'Codeguruprofiler',
    'Codegurureview', 'Codestar', 'Codestarconnections', 'Codestarnotifications',
    'Comprehend', 'Connect', 'Connectcampaigns', 'Controltower', 'Cur',
    'Customerprofiles', 'Databrew', 'Datapipeline', 'Datasync', 'Dms', 'Detective',
    'Devopsguru', 'Directoryservice', 'Dlm', 'Deadline', 'Emr', 'Emrcontainers',
    'Emrserverless', 'Elasticbeanstalk', 'Entityresolution', 'Evidently',
    'Finspace', 'Fis', 'Fms', 'Forecast', 'Frauddetector', 'Fsx', 'Gamelift',
    'Globalaccelerator', 'Grafana', 'Greengrass', 'Greengrassv2', 'Groundstation',
    'Guardduty', 'Healthimaging', 'Healthlake', 'Imagebuilder', 'Inspector',
    'Inspectorv2', 'Internetmonitor', 'Ivs', 'Ivschat', 'Kafkaconnect', 'Kendra',
    'Kendraranking', 'Lakeformation', 'Launchwizard', 'Lex', 'Licensemanager',
    'Lightsail', 'Location', 'Lookoutequipment', 'Lookoutmetrics', 'Lookoutvision',
    'M2', 'Macie', 'Managedblockchain', 'Mediaconnect', 'Mediaconvert',
    'Medialive', 'Mediapackage', 'Mediapackagev2', 'Mediastore', 'Mediatailor',
    'Memorydb', 'Mwaa', 'Networkfirewall', 'Networkmanager', 'Nimblestudio',
    'Oam', 'Omics', 'Opensearchserverless', 'Opsworks', 'Opsworkscm',
    'Organizations', 'Osis', 'Panorama', 'Pcaconnectorad', 'Pcaconnectorscep',
    'Personalize', 'Pinpoint', 'Pinpointemail', 'Proton', 'Qldb', 'Quicksight',
    'Ram', 'Rbin', 'Rekognition', 'Resiliencehub', 'Resourceexplorer2',
    'Resourcegroups', 'Robomaker', 'Rolesanywhere', 'Rum', 'Securityhub',
    'Securitylake', 'Servicecatalog', 'Servicecatalogappregistry', 'Servicediscovery',
    'Shield', 'Signer', 'Simspaceweaver', 'Sns', 'Accessanalyzer', 'Acmpca',
    'Alexaask', 'Bedrock', 'Cloudtrail', 'Docdb', 'Docdbelastic', 'Docddelastic'
  ];
