...
export const NIXPACKS_BINARY_FILE_NAMES: { [platform in SupportedPlatform]: string } = {
...
export const PACK_BINARY_FILE_NAMES: { [platform in SupportedPlatform]: string } = {
  win: 'pack-win.exe',
  macos: 'pack-macos',
  linux: 'pack-linux',
...
export const SESSION_MANAGER_PLUGIN_BINARY_FILE_NAMES: { [platform in SupportedPlatform]: string } = {
  win: 'smp-win.exe',
  macos: 'smp-macos',
  linux: 'smp-linux',
