...
export const DIST_FOLDER_NAME = '__stacktape-dist';
export const PUBLISH_FOLDER_NAME = '__publish-folder';
export const SOURCE_MAPS_FOLDER_NAME = '__source-maps';
export const SOURCE_CODE_DIST_FOLDER_NAME = 'src';
...
export const JSON_SCHEMAS_FOLDER_NAME = 'schemas';
export const SOURCE_MAP_INSTALL_FILENAME = 'source-map-install.js';
export const BINARY_DIST_FOLDER_NAME = '__binary-dist';
export const CLI_RELEASE_FOLDER_NAME = '__release';
export const SDK_RELEASE_FOLDER_NAME = '__release-npm';
export const PLATFORM_PACKAGES_FOLDER_NAME = '__platform-packages';
...
export const SDK_BUILD_DIST_FOLDER_PATH = join(process.cwd(), '__sdk-dist');
...
export const PLATFORM_PACKAGES_FOLDER_PATH = join(process.cwd(), PLATFORM_PACKAGES_FOLDER_NAME);
export const PUBLISH_FOLDER_PATH = join(process.cwd(), PUBLISH_FOLDER_NAME);
export const SOURCE_MAPS_FOLDER_PATH = join(process.cwd(), SOURCE_MAPS_FOLDER_NAME);
...
export const BRIDGE_FILES_DEST_FOLDER_PATH = join(DIST_FOLDER_PATH, BRIDGE_FILES_FOLDER_NAME);
export const CONFIG_SCHEMA_DEST_FOLDER_PATH = join(DIST_FOLDER_PATH, 'config-schema.json');
...
export const SDK_DIST_PATH = join(DIST_FOLDER_PATH, 'sdk.js');
...
export const USER_PROJECTS_PATH = join(process.cwd(), 'user-projects');
...
export const SDK_TYPINGS_PATH = join(process.cwd(), '@generated', 'sdk-typings', 'index.d.ts');

export const CLI_ENTRYFILE_SOURCE_PATH = join(process.cwd(), 'src', 'api', 'cli', 'index.js');
...
export const RELEASE_NOTES_TEMPLATE_PATH = join(process.cwd(), 'scripts', './release-template.md');
...
export const GENERATED_RELEASE_NOTES_PATH = join(process.cwd(), '__RELEASE-NOTES-TEMPLATE__.md');
export const RELATIVE_HELPER_LAMBDAS_DIST_FOLDER_PATH = join(DIST_FOLDER_NAME, HELPER_LAMBDAS_FOLDER_NAME);
...
export const SRC_INDEX_SOURCE_PATH = join(SOURCE_FOLDER_PATH, 'index.ts');
